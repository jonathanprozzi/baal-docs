...
In Moloch v3, both membership and loot shares are ERC20 tokens. This means that their minting, burning and transferability can be controlled by the main DAO contract.
...
1. [DAOhaus v3 dev toolkit (alpha)](https://discord.gg/ABy26DdgfK)
2. [DAOhaus v3's DAO Hub, Summoner and Admin UI (alpha)](https://discord.gg/ABy26DdgfK)
3. [Gnosis Safe App Moloch v3 Summoner (coming soon)](https://discord.gg/ABy26DdgfK)
